...
def main_post(request, tag=None):
    if tag:
    ...
    if request.htmx:
        return render(request, 'snippets/page_posts.html', context)
...
def post_page(request, pk):
    ...
    if request.htmx:
        ...
        return render(request,'snippets/postpage_comments.html', {'comments': comments, 'replyform': replyform})
...
def comment_delete(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect('post-page', post.post.id)
...
def reply_delete(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect('post-page', reply.comment.post.id)

    context={
        'reply': reply
    }

    return render(request, 'comments/reply_delete.html', context)
